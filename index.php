...
<body>
    <div class="full-height">
        ...
        <table border="0">
            <tr>
                <td width="80%">
                    <font class="edoc-logo">JTH </font>
                    <font class="edoc-logo-sub">| The Juba Teaching Hospital Online</font>
                </td>
                <td width="10%">
            ...
            <tr>
                <td colspan="3">
                    <p class="sub-text2">How is health today, Sounds like not good!<br>Don't worry. Find your doctor online Book as you wish with Juba Teaching Hospital Online. <br>
        ...
        <p class="sub-text2 footer-hashen">Chol Daniel Deng.</p>
    </center>
    </div>
</body>
</html>
